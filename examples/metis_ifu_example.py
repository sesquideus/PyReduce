...
class WorkflowExampleMETIS_IFU(Workflow):
    instrument_name: str = "METIS_IFU"
    ...
    mode: str = "NOMINAL"  # LSS_M (settings_metis.json is now optimized for LSS_M mode)
    steps: list[str] = [
        # "bias",
        "flat",
        "orders",
...
if __name__ == "__main__":
    WorkflowExampleMETIS_IFU().process()
